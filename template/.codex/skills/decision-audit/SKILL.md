...
1. Read the user request, the relevant active plan when one exists, `docs/agent/spec-index.yaml`, and its routed project specs.
2. Read `docs/agent/SPEC_DECISION_AUDIT.md` directly.
3. Read `docs/agent/SPEC_PLAN_WORKFLOW.md` when plan lifecycle files are in scope.
