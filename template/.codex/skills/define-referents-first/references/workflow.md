...
```text
python3 scripts/referent-contract.py init .agent-artifacts/referent-contracts/<slug>/contract.json --slug <slug> --task-kind <kind> --source <source> --target <target> --mode advisory
```
