...
`.project-agent-workflow/docs/agent/harness-instructions.json` inventories governing sources and optional supplemental revisions.
...
Use `.project-agent-workflow/scripts/check-harness-profile.py check` to validate a catalog and selection.
