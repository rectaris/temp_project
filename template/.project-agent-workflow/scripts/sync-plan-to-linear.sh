...
usage() {
  cat <<'EOF'
Usage:
  .project-agent-workflow/scripts/sync-plan-to-linear.sh <docs/plan/<active|backlog>/NNN-slug.md> --dry-run
  .project-agent-workflow/scripts/sync-plan-to-linear.sh <docs/plan/checked/.../NNN-slug.md> --dry-run
  .project-agent-workflow/scripts/sync-plan-to-linear.sh <docs/plan/<active|backlog>/NNN-slug.md> --update-issue --dry-run
  .project-agent-workflow/scripts/sync-plan-to-linear.sh <docs/plan/<active|backlog>/NNN-slug.md> --ensure-issue
  .project-agent-workflow/scripts/sync-plan-to-linear.sh <docs/plan/<active|backlog>/NNN-slug.md> --update-issue --apply
  .project-agent-workflow/scripts/sync-plan-to-linear.sh <docs/plan/active/NNN-slug.md> --preflight-completion-status
  .project-agent-workflow/scripts/sync-plan-to-linear.sh <docs/plan/checked/.../NNN-slug.md> --update-status --apply
  .project-agent-workflow/scripts/sync-plan-to-linear.sh <docs/plan/<active|backlog>/NNN-slug.md> --apply --from-payload <payload.json>
