...
1. Follow `AGENTS.md`, parent workspace rules, and project-local `.project-agent-workflow/docs/agent/spec-index.yaml`.
...
- After a formal validation failure, reproduce the exact failure as described in `.project-agent-workflow/skills/decision-audit/references/implementation-preflight.md` before proposing a repair.
