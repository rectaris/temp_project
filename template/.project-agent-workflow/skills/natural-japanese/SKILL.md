...
Use this skill as an optional review layer after `.project-agent-workflow/docs/agent/SPEC_JAPANESE_TECH_WRITING.md`.
...
4. For file work, run `python3 .project-agent-workflow/skills/natural-japanese/scripts/check-japanese-prose.py --json <file>` at most once per draft unless the user asks for another pass.
