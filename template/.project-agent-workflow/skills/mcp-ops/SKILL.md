...
1. Read `.project-agent-workflow/docs/agent/SPEC_EXTERNAL_SERVICES.md` and `docs/agent/external-services.yaml`.
2. Run `python3 .project-agent-workflow/scripts/check-external-service-policy.py check`.
