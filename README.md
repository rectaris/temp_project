...
導入する版を現在の最新安定版である `v1.4.7` に固定する場合：

```sh
copier copy --trust --vcs-ref v1.4.7 https://github.com/rectaris/temp_project.git /path/to/repo
```
...
```sh
copier update --trust --vcs-ref v1.4.7
```
