...
integration_gates:
  - replace the stopped Plan 094 naming boundary with exact checked and replanned archive identity
...
- [x] Archive and commit the integration plan before lineage-certification Plans 096 and 097.

## Validation Notes

- This integration successor copies every Plan 092 acceptance item exactly.
- Plan 094 stopped after two parent-direct Medium review rounds. This plan owns the remaining exact archive-path and compatible contract-name rules before the full validation gate.
