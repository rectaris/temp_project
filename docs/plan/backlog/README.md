...
このうち311と310と313は完了済みで、312は権威的検証で停止したまま再開を待っている。
...
[313](../checked/2026/09/01-15/313-read-activation-archives-of-every-vintage.md)はその修復で、起動参照が旧版の完了記録も読めるようになった。312は新しい実行で再開できる。
