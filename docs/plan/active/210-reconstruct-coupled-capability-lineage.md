...
status: deferred
completion_deferred_reason: Plan 213 must be checked, Plan 215 must replace the active predecessor, and Plans 214 and 215 must both be checked before implementation.
...
predecessor_plans:
  - docs/plan/active/213-reconstruct-stopped-lifecycle-chain.md
integration_gates:
  - execute only after Plans 206, 209, 214, and 215 are checked and their exact checked archives are bound
...
- Before Plan 213 completes, replace this plan's active Plan 213 predecessor with active Plan 215 and replace the Plan 207/208 context paths with their exact replanned archives plus active Plans 214 and 215.
...
- [ ] Verify the clean checkpoint ancestry, checked Plans 206, 209, 213, 214, and 215, exact replanned archives for Plans 207 and 208, exact source bytes, exact source acceptance, current active index, and committed rejected-candidate blobs.
