...
predecessor_plans:
  - docs/plan/active/209-enable-direct-active-source-reconstruction.md
integration_gates:
  - execute only after Plans 206 through 209 are checked and their exact checked archives are bound
...
- [ ] Verify the clean checkpoint ancestry, checked Plans 206 through 209, exact source bytes, exact source acceptance, current active index, and committed rejected-candidate blobs.
