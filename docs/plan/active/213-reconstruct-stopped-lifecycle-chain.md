...
- The same lifecycle update must replace Plan 217's active Plan 213 predecessor and context with the exact checked Plan 213 archive while Plan 217 stays `deferred` behind checked Plans 215 and 216.
