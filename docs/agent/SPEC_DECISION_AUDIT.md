...
Use the user's language for the audit response. Japanese output is allowed when the user communicates in Japanese.
...
`docs/agent/SPEC_PLAN_WORKFLOW.md` or `docs/agent/SPEC_SECURITY.md`.
