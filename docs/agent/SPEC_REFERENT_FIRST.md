...
Before completing or archiving a plan, inspect its related records with `python3 scripts/referent-contract.py pending --target <plan-path>` and reconcile their draft locations and applicability.
