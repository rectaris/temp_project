...
When Codex hooks are enabled, the existing Stop review gate requires one final review of a substantive proposed message.

That hook enforces the review step but does not prove that every reader will understand the resulting text.
