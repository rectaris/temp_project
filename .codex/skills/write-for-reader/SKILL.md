...
1. Read `docs/agent/SPEC_USER_COMMUNICATION.md` directly.
...
For Japanese text, follow `docs/agent/SPEC_JAPANESE_TECH_WRITING.md` first, then use `.codex/skills/natural-japanese/SKILL.md` at the depth appropriate to the message.
